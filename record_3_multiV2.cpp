...
int main( int /*argc*/, char* /*argv*/[] )
{
    ...
    try
    {
        ...
        for (size_t i = 0; i < cameras.GetSize(); ++i)
        {
            ...
            cout << "Device S/N " << cameras[i].GetDeviceInfo().GetSerialNumber() << endl;
        ...
        videoWriter_A.Open( "01.mp4" );
        videoWriter_B.Open( "02.mp4" );
        videoWriter_C.Open( "03.mp4" );
...
//                // Print the index and the model name of the camera.
            //    cout << "Camera " << cameraContextValue << ": " << cameras[cameraContextValue].GetDeviceInfo().GetSerialNumber() << endl;
               if(cameras[cameraContextValue].GetDeviceInfo().GetSerialNumber()=="23466438"){
                //    std::cout<<"True"<<std::endl; 
                    videoWriter_A.Add( ptrGrabResult );
               }
               if(cameras[cameraContextValue].GetDeviceInfo().GetSerialNumber()=="23466439"){
                    videoWriter_B.Add( ptrGrabResult );

               }
               if(cameras[cameraContextValue].GetDeviceInfo().GetSerialNumber()=="23466448"){
                    videoWriter_C.Add( ptrGrabResult );
               }
...
//                cout << "Gray value of first pixel: " << (uint32_t) pImageBuffer[0] << endl << endl;
                ...
                cv::resize(openCvImage, openCvImage, cv::Size(), 0.5, 0.5);
                cv::imshow(to_string(cameraContextValue), openCvImage);
            }
            else
            {
